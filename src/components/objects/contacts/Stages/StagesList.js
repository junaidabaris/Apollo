...
function StagesList() {
    const data = [
        ...
        { title: "Not Interested", coloe_code: "#e86f5f" },
        { title: "Unresponsive", coloe_code: "#4b814f" },
        { title: "Replied", coloe_code: "#867250" },
        { title: "Approaching", coloe_code: "#867250" },
        { title: "Changed Job", coloe_code: "#c2c0bc" },
        { title: "Interested", coloe_code: "#4b814f" },
        { title: "Do Not Contact", coloe_code: "#e86f5f" },
    ];
        ...
        <div>
            <div className="table-responsive active-projects style-1">
                <div className="tbl-caption d-flex justify-content-between align-items-center">
                    <h4 className="heading mb-0 p-2">Apollo Contact Stage</h4>
