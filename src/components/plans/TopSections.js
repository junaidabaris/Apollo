...
const TopSections = () => {
    ...
    return (
        <div style={{ fontFamily: "Arial, sans-serif", textAlign: "center", margin: "20px" }}>
            ...
            <div style={{ display: "inline-block", border: "1px solid #ddd", borderRadius: "25px", overflow: "hidden" }}>
                <button
                    style={{
                        padding: "10px 20px",
                        backgroundColor: billingType === "Annual Billing" ? "#007bff" : "white",
                ...
                <button
                    style={{
                        padding: "10px 20px",
                        backgroundColor: billingType === "Monthly Billing" ? "#007bff" : "white",
            ...
            <p style={{ margin: "10px 0", fontSize: "14px", color: "green" }}>Save 20%</p>
