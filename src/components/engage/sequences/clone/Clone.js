    ...
    <Modal show={show} onHide={onHide}>
      ...
      <Modal.Body>
        <div className="row">
          ...
          <div className="col-lg-12">
            <p>
              <strong>Monday:</strong> 8 AM – 5 PM
            </p>
            <p>
              <strong>Tuesday:</strong> 8 AM – 5 PM
            </p>
            <p>
              <strong>Wednesday:</strong> 8 AM – 5 PM
            </p>
            <p>
              <strong>Thursday:</strong> 8 AM – 5 PM
            </p>
            <p>
              <strong>Friday:</strong> 8 AM – 5 PM
            </p>
          </div>
        </div>
      </Modal.Body>
