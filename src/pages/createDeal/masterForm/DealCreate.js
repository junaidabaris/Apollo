                        ...
                        <form className="tbl-captionn " onSubmit={handleSubmit}>
                            <div className="row inputSty">
                                ...
                                <div className="col-xl-4 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        className={`form-control ${errors.deal_name ? 'is-invalid' : ''}`}
                                ...
                                <div className="col-xl-4 mb-3">
                                    ...
                                    <select
                                        className={`form-select ${errors.pipeline ? 'is-invalid' : ''}`}
                                ...
                                <div className="col-xl-4 mb-3">
                                    ...
                                    <input
                                        type="date"
                                        className={`form-control ${errors.estimated_close_date ? 'is-invalid' : ''}`}
                                    ...
                                    {errors.estimated_close_date && (
                                        <div className="invalid-feedback">{errors.estimated_close_date}</div>
                                    )}
                                </div>
                                ...
                                <div className="col-xl-4 mb-3">
                                    <label htmlFor="lead_source">Lead Source</label>
                                     ...
                                     <select
                                        className={`form-select ${errors.lead_source ? 'is-invalid' : ''}`}
