                        ...
                        <div className="col-lg-12">
                            <div className="input-group mb-3">
                                ...
                                <span className="input-group-text input-group-text-2" id="basic-addon1" >
                                    <select className="form-select" aria-label="Default select example" value={countryCode} onChange={handleCountryCode}>
                ...
                <div className="col-lg-12">
                  <div className="headinf-otp">
                    ...
                    <p className="set-lage">
                      Enter 6 Digit Number Verification Code On Your Mobile
                      Number!
                    </p>
                  </div>
                  {isTimerEnded ? (
